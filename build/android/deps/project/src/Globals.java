// DO NOT EDIT THIS FILE - it is automatically generated, ALL YOUR CHANGES WILL BE OVERWRITTEN, edit the file under project/javaSDL2 dir
/*
...
class Globals
{
	...
	public static String ApplicationName = "OpenLieroX";
	public static String AppLibraries[] = { "sdl_native_helpers", "SDL2", "SDL2_image", "SDL2_mixer", "xml2", "curl", "ssl", "crypto", "lzma", "mad", "openal" };
	public static String AppMainLibraries[] = {  "application" };
	...
	public static final boolean UsingSDL2 = true;
	public static String[] DataDownloadUrl = { "!!Game data|data.zip.xz",  };
	...
	public static String ReadmeText = "This game is best played with a gamepad. Two-player mode requires two gamepads. Tap the screen to dig.^tv:";
	...
	public static String DeleteFilesOnUpgrade = "libsdl-DownloadFinished-0.flag";
	public static int AppTouchscreenKeyboardKeysAmount = 4;
	public static String[] AppTouchscreenKeyboardKeysNames = "Jump Rope Shoot SelectWeapon Chat".split(" ");
	public static int StartupMenuButtonTimeout = 1000;
	public static int AppMinimumRAM = 0;
	 // If you see error here - update HiddenMenuOptions in your AndroidAppSettings.cfg: change OptionalDownloadConfig to SettingsMenuMisc.OptionalDownloadConfig etc.
	...
	public static int TouchscreenKeyboardTheme = 3;
