...
#
# All clones land in this directory (build/android/deps/<name>) and are
# pinned to a specific tag. The CMake build under
# build/android/app/src/main/jni/CMakeLists.txt consumes them via
# add_subdirectory().
