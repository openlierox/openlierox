...
{
	SDL_Window* win = VideoPostProcessor::window().get();
	if(!win)
		return 0;
...
void SubclassWindow()
{
	...
	// GWLP_WNDPROC + SetWindowLongPtr work on both x86 and x64; the
	// older GWL_WNDPROC / SetWindowLong forms truncate on x64.
